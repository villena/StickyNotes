<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Friend_Profile.aspx.cs" Inherits="WebApplication1.Formulario_web16" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="clear:right; margin-left:250px">
        ...
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" ssClass="cssbutton" Text="Back to Home" PostBackUrl="../Asp_forms/Friends.aspx" />
    </div>
    </asp:Panel>
</asp:Content>
